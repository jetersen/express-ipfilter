...
describe('enforcing IP address blacklist restrictions', () => {
  ...
  it('should deny an IPv4 ip transmitted as IPv6', done => {
...
describe('enforcing IP address whitelist restrictions', () => {
  describe('with a whitelist with no ips', () => {
    beforeEach(() => {
...
//codio Tests
describe('enforcing codio based client IP address', () => {
  describe('blacklist restrictions', () => {
    ...
    it('should allow all non-blacklisted forwarded ips', done => {
      req.headers['x-real-ip'] = '127.0.0.2'
      ipfilter(req, {}, () => {
        done()
      })
    })
  ...
  describe('while disabled', () => {
    ...
    it('should allow all whitelisted forwarded ips', done => {
      req.headers['x-real-ip'] = '127.0.0.2'
      req.connection.remoteAddress = '127.0.0.1'
      ipfilter(req, {}, () => {
        done()
